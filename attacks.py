...
def fgsm_attack(model, testloader, epsilon):
    model.eval()
    correct = 0
    total = 0
...
def pgd_attack(model, testloader, epsilon, alpha, iterations):#, n_restarts):
    model.eval()
    correct = 0
    total = 0
...
def rfgsm_attack(model, testloader, epsilon, alpha, iterations):
    model.eval()
    correct = 0
    total = 0
...
def fab_attack(model, testloader, epsilon, iterations, n_classes=10):   #, epsilon
    model.eval()
    correct = 0
    total = 0
...
def square_attack(model, testloader, epsilon):   #, epsilon
    model.eval()
    correct = 0
    total = 0
...
def apgd_attack(model, testloader, epsilon, iterations, n_restarts):   #, epsilon
    model.eval()
    correct = 0
    total = 0
...
def apgdt_attack(model, testloader, epsilon, n_classes=10):   #, epsilon
    model.eval()
    correct = 0
    total = 0
...
def auto_attack(model, testloader, epsilon, n_classes=10):   #, epsilon
    model.eval()
    correct = 0
    total = 0
