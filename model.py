...
class AuxiliaryHeadCIFAR(nn.Module):
    ...
    def __init__(self, C, num_classes,is_medmnist):
...
class NetworkCIFAR(nn.Module):
    def __init__(self, C, num_classes, layers, auxiliary, genotype,is_medmnist, drop_path_prob, mode, SE=False, height_curr=None):
        ...
        if auxiliary:
            self.auxiliary_head = AuxiliaryHeadCIFAR(C_to_auxiliary, num_classes,is_medmnist)
