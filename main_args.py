...
if __name__ == '__main__':
  ...
  cutout = False
  multigpu_num = 0
  medmnist_dataset = 'organcmnist'
  is_medmnist = True
  is_tune= False
  #DE strategies in mealpy are from 0 to 5
  de_strategy = 1
  print(de_strategy)
  #CR is from 0.5 to 0.95
  CR = 0.5
  print(CR)
  #WF is from 0.5 to 0.95
  WF = 0.6
  #Multi-Objective
  # ga = MOGA(population_size,number_of_generations,crossover_prob,mutation_prob,blocks_size,num_classes,in_channels,epochs,batch_size,layers,n_channels,dropout_rate,retrain,resume_train,cutout,multigpu_num,medmnist_dataset,is_medmnist)
  # #Running the algorithm
  # ga.evolve()
  #Single Objective
  ga = SOGA(population_size,number_of_generations,crossover_prob,mutation_prob,blocks_size,num_classes,in_channels,epochs,batch_size,layers,n_channels,dropout_rate,retrain,resume_train,cutout,multigpu_num,medmnist_dataset,is_medmnist)
  #Running the algorithm
  ga.mealypy_evolve('de',15,20,medmnist_dataset,CR,WF,de_strategy)
